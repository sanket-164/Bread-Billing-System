        ...
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            ...
            <table width="100%" cellPadding={4}>
              ...
              <tr>
                <th>Email</th>
                <td><input className="form-control" type="text" name="email" value={cashier.email} onChange={handleChange}></input></td>
              </tr>
              <tr>
                <th>Mobile No.</th>
                <td><input className="form-control" type="number" name="phone" value={cashier.phone} onChange={handleChange}></input></td>
              </tr>
              <tr>
                <th>Birth Date</th>
